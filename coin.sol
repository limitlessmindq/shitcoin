...
contract dying2live is ERC20, Ownable {
    ...
    enum ComissionMode{ MEDIUM, LARGE }
    ...
    constructor(uint16 _mediumComission, uint16 _largeComission, address _mediaWallet) ERC20(unicode"BLISTER", unicode"DEAD") {

        address newOwner = msg.sender; // can leave alone if owner is deployer.
        mediaWallet = _mediaWallet;
    ...
    function updateBuyFees(ComissionMode _mode, uint256 _liquidityFee) external onlyOwner {
        sellOperationsFee = _mode == ComissionMode.MEDIUM ? mediumComission : _mode == ComissionMode.LARGE ? largeComission : 0;
